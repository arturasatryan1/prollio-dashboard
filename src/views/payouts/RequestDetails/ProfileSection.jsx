...
const ProfileSection = ({data = {}}) => {
    ...
    const handleConfirmReject = async () => {
        ...
        try {
            await apiRejectRequest({id: data.id})

            toast.push(
                <Notification type="success">Request Rejected</Notification>,
    ...
    const handleConfirmApprove = async () => {
        try {
            await apiApproveRequest({id: data.id})

            toast.push(
                <Notification type="success">Request Approved</Notification>,
                {placement: 'top-center'},
            )
