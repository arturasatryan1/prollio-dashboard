        ...
        <Card className="w-full">
            <div className="flex flex-col xl:justify-between h-full 2xl:min-w-[360px] mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-1 gap-y-7 gap-x-4">
                    <CustomerInfoField title={t('Full Name')} value={`${data.first_name} ${data.last_name}`}/>
                    <CustomerInfoField title={t('Username')} value={data.username}/>
                    <CustomerInfoField title={t('Total Spent')} value={data.spent} decimal={true}/>
                </div>
