...
import useTransferList from "@/views/transfers/TransferList/hooks/useTransferList.js";
...
const TransferListTableFilter = () => {
    const [dialogIsOpen, setIsOpen] = useState(false)
    const [events, setEvents] = useState([])
    const [eventFetching, setEventFetching] = useState(false)
    const {filterData, setFilterData} = useTransferList()
...
export default TransferListTableFilter
